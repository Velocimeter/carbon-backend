...
export class RenameReferrerToAccount1745891835698 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_315b1775b7475b5c4b5f03c6eb" ON "register_code_events" ("account", "blockchainType", "exchangeId") `,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_b070301b78a0ef1f65427a1425" ON "set_trader_referral_code_events" ("blockchainType", "code", "exchangeId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_bb402e760401db84fb6cb4613f" ON "set_trader_referral_code_events" ("account", "blockchainType", "exchangeId") `,
    );
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_52b3d41684454668d3ff4983f3" ON "register_code_events" ("blockchainType", "exchangeId", "referrer") `,
    );
