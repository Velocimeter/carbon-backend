...
export class InitialSchema1745824553346 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "tvl" ("id" SERIAL NOT NULL, "blockchainType" character varying NOT NULL, "exchangeId" character varying NOT NULL, "evt_block_time" TIMESTAMP NOT NULL, "evt_block_number" integer NOT NULL, "strategyId" text NOT NULL, "pairName" text NOT NULL, "pairId" integer NOT NULL, "symbol" text NOT NULL, "address" text NOT NULL, "tvl" text NOT NULL, "reason" text NOT NULL, "transaction_index" text NOT NULL, CONSTRAINT "UQ_837985c1c667096fcb6aba2a437" UNIQUE ("blockchainType", "exchangeId", "strategyId", "pairName", "symbol", "tvl", "address", "evt_block_time", "evt_block_number", "reason", "transaction_index"), CONSTRAINT "PK_8b7a23cbf87dab94680ce91ad20" PRIMARY KEY ("id", "evt_block_time"))`);
        ...
        await queryRunner.query(`CREATE TABLE "tokens" ("id" SERIAL NOT NULL, "blockchainType" character varying NOT NULL, "exchangeId" character varying NOT NULL, "address" character varying NOT NULL, "symbol" character varying NOT NULL, "name" character varying NOT NULL, "decimals" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_3001e89ada36263dabf1fb6210a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_c03a21b4dead9ab3345f3ad490" ON "tokens-traded-events" ("sourceTokenId") `);
        await queryRunner.query(`CREATE INDEX "IDX_4bec19484efcbe1a523521c5fe" ON "tokens-traded-events" ("targetTokenId") `);
        await queryRunner.query(`CREATE INDEX "IDX_4b447c4070d7d9f532817c8867" ON "tokens-traded-events" ("trader") `);
        await queryRunner.query(`CREATE INDEX "IDX_6d5a448e3ac65b30cc6ebb45b4" ON "tokens-traded-events" ("transactionIndex") `);
        await queryRunner.query(`CREATE INDEX "IDX_974b69b8082522efa7f2ba47c1" ON "tokens-traded-events" ("transactionHash") `);
        ...
        await queryRunner.query(`CREATE TABLE "pairs" ("id" SERIAL NOT NULL, "blockchainType" character varying NOT NULL, "exchangeId" character varying NOT NULL, "name" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "blockId" integer, "token0Id" integer, "token1Id" integer, CONSTRAINT "PK_bfc550b07b52c37db12aa7d8e69" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "total-tvl" ("id" SERIAL NOT NULL, "blockchainType" character varying NOT NULL, "exchangeId" character varying NOT NULL, "timestamp" TIMESTAMP NOT NULL, "tvl" text NOT NULL, CONSTRAINT "UQ_7fe5b00781f6564ec055b4f88ab" UNIQUE ("blockchainType", "exchangeId", "timestamp"), CONSTRAINT "PK_11e6b29ef16c61c5364a9d78c14" PRIMARY KEY ("id", "timestamp"))`);
        ...
        await queryRunner.query(`CREATE TABLE "historic-quotes" ("id" SERIAL NOT NULL, "blockchainType" character varying NOT NULL, "timestamp" TIMESTAMP NOT NULL, "tokenAddress" character varying NOT NULL, "provider" character varying NOT NULL, "usd" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "updatedAt" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, CONSTRAINT "PK_e342adbd6f8f907b412ff681929" PRIMARY KEY ("id", "timestamp"))`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_a37307f204a293b6437632a478" ON "activities-v2" ("baseSellTokenAddress") `);
        await queryRunner.query(`CREATE INDEX "IDX_7ba7181393b295d77c12e34deb" ON "activities-v2" ("quoteBuyTokenAddress") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_144bbf6ec862217c81f0d75b68" ON "referral_states" ("owner", "chain_id") `);
        ...
        await queryRunner.query(`CREATE TABLE "voucher-transfer-events" ("id" SERIAL NOT NULL, "blockchainType" character varying NOT NULL, "exchangeId" character varying NOT NULL, "strategyId" character varying NOT NULL, "timestamp" TIMESTAMP NOT NULL, "from" character varying NOT NULL, "to" character varying NOT NULL, "transactionIndex" integer NOT NULL, "transactionHash" character varying NOT NULL, "logIndex" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "blockId" integer, CONSTRAINT "UQ_b302936970b7fd28132928c4e77" UNIQUE ("transactionIndex", "transactionHash", "logIndex"), CONSTRAINT "PK_15f265cac4047455031ec2b4e41" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_2e20328d5565ff6b3131ae93b5" ON "voucher-transfer-events" ("blockchainType") `);
        await queryRunner.query(`CREATE INDEX "IDX_3e7da58e7cdefd620d5d780fe8" ON "voucher-transfer-events" ("exchangeId") `);
        await queryRunner.query(`CREATE INDEX "IDX_dcceb3e56b344cc9c8c703ae2d" ON "voucher-transfer-events" ("blockId") `);
        await queryRunner.query(`CREATE TABLE "strategy-updated-events" ("id" SERIAL NOT NULL, "blockchainType" character varying NOT NULL, "exchangeId" character varying NOT NULL, "strategyId" character varying NOT NULL, "timestamp" TIMESTAMP NOT NULL, "reason" integer NOT NULL, "order0" character varying NOT NULL, "order1" character varying NOT NULL, "transactionIndex" integer NOT NULL, "transactionHash" character varying NOT NULL, "logIndex" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "pairId" integer, "blockId" integer, "token0Id" integer, "token1Id" integer, CONSTRAINT "UQ_b206162147f84fc87256bf03b23" UNIQUE ("transactionIndex", "transactionHash", "logIndex"), CONSTRAINT "PK_03ba1851eb69ff0f541a632279f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_0c842871c198090f0467451e9d" ON "strategy-updated-events" ("blockchainType") `);
        await queryRunner.query(`CREATE INDEX "IDX_bc3628a6daaf2e7e169292f4ce" ON "strategy-updated-events" ("exchangeId") `);
        await queryRunner.query(`CREATE INDEX "IDX_d8ddb719df9d2a26006b415f98" ON "strategy-updated-events" ("strategyId") `);
        await queryRunner.query(`CREATE INDEX "IDX_f6cd36e84afc2fdf1d9cea35ce" ON "strategy-updated-events" ("blockId") `);
        await queryRunner.query(`CREATE INDEX "IDX_d2611fb5f6bb25ef81a62b20fb" ON "strategy-updated-events" ("timestamp") `);
        await queryRunner.query(`CREATE TABLE "vortex-tokens-traded-events" ("id" SERIAL NOT NULL, "blockchainType" character varying NOT NULL, "exchangeId" character varying NOT NULL, "caller" character varying NOT NULL, "token" character varying NOT NULL, "sourceAmount" text NOT NULL, "targetAmount" text NOT NULL, "transactionIndex" integer NOT NULL, "transactionHash" character varying NOT NULL, "timestamp" TIMESTAMP NOT NULL, "logIndex" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "blockId" integer, CONSTRAINT "UQ_d43ac776a60b8c78fb2e8b4b64c" UNIQUE ("transactionIndex", "transactionHash", "logIndex"), CONSTRAINT "PK_a14b40d4c35229dc0f462699fab" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "trading-fee-ppm-updated-events" ("id" SERIAL NOT NULL, "blockchainType" character varying NOT NULL, "exchangeId" character varying NOT NULL, "timestamp" TIMESTAMP NOT NULL, "prevFeePPM" integer NOT NULL, "newFeePPM" integer NOT NULL, "transactionIndex" integer NOT NULL, "transactionHash" character varying NOT NULL, "logIndex" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "blockId" integer, CONSTRAINT "UQ_059b582e451654f70bebb491e05" UNIQUE ("transactionIndex", "transactionHash", "logIndex"), CONSTRAINT "PK_c3db6da119f4169b7563d1fdc93" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_af9af71f6ad35cf07505151c41" ON "trading-fee-ppm-updated-events" ("blockchainType") `);
        await queryRunner.query(`CREATE INDEX "IDX_ec78d4bb8fa7e46d00ec1d26e2" ON "trading-fee-ppm-updated-events" ("exchangeId") `);
        await queryRunner.query(`CREATE INDEX "IDX_aca9132d7db5f0385024667004" ON "trading-fee-ppm-updated-events" ("blockId") `);
        await queryRunner.query(`CREATE TABLE "strategy-created-events" ("id" SERIAL NOT NULL, "strategyId" character varying NOT NULL, "blockchainType" character varying NOT NULL, "exchangeId" character varying NOT NULL, "timestamp" TIMESTAMP NOT NULL, "owner" character varying NOT NULL, "order0" character varying NOT NULL, "order1" character varying NOT NULL, "transactionIndex" integer NOT NULL, "transactionHash" character varying NOT NULL, "logIndex" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "pairId" integer, "blockId" integer, "token0Id" integer, "token1Id" integer, CONSTRAINT "UQ_52086ff805f342661c5b77bc1ae" UNIQUE ("transactionIndex", "transactionHash", "logIndex"), CONSTRAINT "PK_3121f8f9aa9a96e48e103ef09c1" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_00faad78686d13fd0c26264ae8" ON "strategy-created-events" ("strategyId") `);
        await queryRunner.query(`CREATE INDEX "IDX_9c5a2e9a334403254efb836f04" ON "strategy-created-events" ("blockId") `);
        await queryRunner.query(`CREATE INDEX "IDX_7671de629ff77fbfb76d048416" ON "strategy-created-events" ("blockchainType") `);
        await queryRunner.query(`CREATE INDEX "IDX_32ec6fba5ace9de71aa011bf0a" ON "strategy-created-events" ("exchangeId") `);
        await queryRunner.query(`CREATE INDEX "IDX_c239f8c77980389a6ed16872d3" ON "strategy-created-events" ("timestamp") `);
        ...
        await queryRunner.query(`CREATE TABLE "strategy-deleted-events" ("id" SERIAL NOT NULL, "blockchainType" character varying NOT NULL, "exchangeId" character varying NOT NULL, "strategyId" character varying NOT NULL, "timestamp" TIMESTAMP NOT NULL, "order0" character varying NOT NULL, "order1" character varying NOT NULL, "transactionIndex" integer NOT NULL, "transactionHash" character varying NOT NULL, "logIndex" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "pairId" integer, "blockId" integer, "token0Id" integer, "token1Id" integer, CONSTRAINT "UQ_9830850139cbddfd88f602fbf50" UNIQUE ("transactionIndex", "transactionHash", "logIndex"), CONSTRAINT "PK_631d016adec08e3c3ae77c267b6" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_8b93141dbde79a439f8c1bfd46" ON "strategy-deleted-events" ("blockchainType") `);
        await queryRunner.query(`CREATE INDEX "IDX_2019b1709d451d3739d3e93aa9" ON "strategy-deleted-events" ("exchangeId") `);
        await queryRunner.query(`CREATE INDEX "IDX_19b2559796c490b51ad46c6686" ON "strategy-deleted-events" ("strategyId") `);
        await queryRunner.query(`CREATE INDEX "IDX_eac564b54c2e686f3bbbdfb7f7" ON "strategy-deleted-events" ("blockId") `);
        await queryRunner.query(`CREATE TABLE "protection-removed-events" ("id" SERIAL NOT NULL, "blockchainType" character varying NOT NULL, "exchangeId" character varying NOT NULL, "provider" character varying NOT NULL, "poolToken" character varying NOT NULL, "reserveToken" character varying NOT NULL, "poolAmount" character varying NOT NULL, "reserveAmount" character varying NOT NULL, "transactionIndex" integer NOT NULL, "transactionHash" character varying NOT NULL, "timestamp" TIMESTAMP NOT NULL, "logIndex" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "blockId" integer, CONSTRAINT "UQ_c87b82d1fe5fed8380696892100" UNIQUE ("transactionIndex", "transactionHash", "logIndex"), CONSTRAINT "PK_fe2105de523181c1194dd0833c9" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_d51e7a593e43512128d7d941f2" ON "protection-removed-events" ("blockchainType") `);
        await queryRunner.query(`CREATE INDEX "IDX_e42e2c560058b9b006a4f5af15" ON "protection-removed-events" ("exchangeId") `);
        await queryRunner.query(`CREATE INDEX "IDX_931a18b62f3a83d583b1990458" ON "protection-removed-events" ("blockId") `);
        await queryRunner.query(`CREATE INDEX "IDX_2efb4ea266c393e1e8bfe51c88" ON "protection-removed-events" ("timestamp") `);
        await queryRunner.query(`CREATE TABLE "set_handler_events" ("id" SERIAL NOT NULL, "blockchainType" character varying NOT NULL, "exchangeId" character varying NOT NULL, "handler" character varying(42) NOT NULL, "isActive" boolean NOT NULL, "chain_id" integer NOT NULL, "transactionIndex" integer NOT NULL, "transactionHash" character varying NOT NULL, "logIndex" integer NOT NULL, "timestamp" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "blockId" integer, CONSTRAINT "UQ_a6ed51b46f6ba9975de5860ed88" UNIQUE ("transactionIndex", "transactionHash", "logIndex"), CONSTRAINT "PK_ba5896238e4765b86d251e0ecfa" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_aa2501d866cdfc5200df049f45" ON "set_handler_events" ("blockchainType") `);
        ...
        await queryRunner.query(`CREATE TABLE "set_code_owner_events" ("id" SERIAL NOT NULL, "blockchainType" character varying NOT NULL, "exchangeId" character varying NOT NULL, "account" character varying(42) NOT NULL, "newAccount" character varying(42) NOT NULL, "code" character varying(66) NOT NULL, "code_decoded" character varying(255), "chain_id" integer NOT NULL, "transactionIndex" integer NOT NULL, "transactionHash" character varying NOT NULL, "logIndex" integer NOT NULL, "timestamp" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "blockId" integer, CONSTRAINT "UQ_b6facd14ca5dc964cd3818e59ea" UNIQUE ("transactionIndex", "transactionHash", "logIndex"), CONSTRAINT "PK_653e06c96d10bde35204e28c610" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_1d1cf9a5c6d7f0b34dedaa0de2" ON "set_code_owner_events" ("blockchainType") `);
        ...
        await queryRunner.query(`CREATE TABLE "register_code_events" ("id" SERIAL NOT NULL, "blockchainType" character varying NOT NULL, "exchangeId" character varying NOT NULL, "code" character varying(66) NOT NULL, "code_decoded" character varying(255), "referrer" character varying(42) NOT NULL, "chain_id" integer NOT NULL, "transactionIndex" integer NOT NULL, "transactionHash" character varying NOT NULL, "logIndex" integer NOT NULL, "timestamp" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "blockId" integer, CONSTRAINT "UQ_00bef4a43f2f0e671aa44c82f73" UNIQUE ("transactionIndex", "transactionHash", "logIndex"), CONSTRAINT "PK_98a131e25db3d6284c28ca8bd2e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_62060ee477606b92e2ba58c78d" ON "register_code_events" ("blockchainType") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_52b3d41684454668d3ff4983f3" ON "register_code_events" ("referrer", "blockchainType", "exchangeId") `);
        await queryRunner.query(`CREATE INDEX "IDX_77d8c2b7d27a7ec584a56a7244" ON "register_code_events" ("code", "blockchainType", "exchangeId") `);
        await queryRunner.query(`CREATE TABLE "set_trader_referral_code_events" ("id" SERIAL NOT NULL, "blockchainType" character varying NOT NULL, "exchangeId" character varying NOT NULL, "account" character varying(42) NOT NULL, "code" character varying(66) NOT NULL, "code_decoded" character varying(255), "chain_id" integer NOT NULL, "transactionIndex" integer NOT NULL, "transactionHash" character varying NOT NULL, "logIndex" integer NOT NULL, "timestamp" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "blockId" integer, CONSTRAINT "UQ_9d2ce81edcb2072e2dc529f5037" UNIQUE ("transactionIndex", "transactionHash", "logIndex"), CONSTRAINT "PK_1c84074249a0a210b2be4f2c98a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_1b422f1938468d26ee7bbeb6f1" ON "set_trader_referral_code_events" ("blockchainType") `);
        await queryRunner.query(`CREATE INDEX "IDX_c5320355c9ae51762a5a7b2165" ON "set_trader_referral_code_events" ("exchangeId") `);
        await queryRunner.query(`CREATE INDEX "IDX_dcc1860c4507bfd4541579ba12" ON "set_trader_referral_code_events" ("blockId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_73274b9c23f5da11a670ff2348" ON "set_trader_referral_code_events" ("timestamp") `);
        ...
        await queryRunner.query(`CREATE TABLE "pair-created-events" ("id" SERIAL NOT NULL, "blockchainType" character varying NOT NULL, "exchangeId" character varying NOT NULL, "token0" character varying NOT NULL, "token1" character varying NOT NULL, "transactionIndex" integer NOT NULL, "transactionHash" character varying NOT NULL, "logIndex" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "blockId" integer, CONSTRAINT "UQ_dcc1a2cd3b18918ca3a8b47007d" UNIQUE ("transactionIndex", "transactionHash", "logIndex"), CONSTRAINT "PK_2e5b322880060ee74d19b8d4a07" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_8b60bbe8a3935e59d07f9e2084" ON "pair-created-events" ("blockchainType") `);
        ...
        await queryRunner.query(`CREATE TABLE "set_referrer_discount_share_events" ("id" SERIAL NOT NULL, "blockchainType" character varying NOT NULL, "exchangeId" character varying NOT NULL, "referrer" character varying(42) NOT NULL, "discountShare" character varying NOT NULL, "chain_id" integer NOT NULL, "transactionIndex" integer NOT NULL, "transactionHash" character varying NOT NULL, "logIndex" integer NOT NULL, "timestamp" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "blockId" integer, CONSTRAINT "UQ_299678a0e8b764ce095729325ba" UNIQUE ("transactionIndex", "transactionHash", "logIndex"), CONSTRAINT "PK_6b2df1132e36061bb7dac8a1897" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_3972f3f71800c394a491a8e8ed" ON "set_referrer_discount_share_events" ("blockchainType") `);
        await queryRunner.query(`CREATE INDEX "IDX_24fd792b047faee1647097112d" ON "set_referrer_discount_share_events" ("exchangeId") `);
        await queryRunner.query(`CREATE INDEX "IDX_6e7359ba2064496b809f1855d4" ON "set_referrer_discount_share_events" ("blockId") `);
        await queryRunner.query(`CREATE INDEX "IDX_f53bb36ee339896fb2b4abd644" ON "set_referrer_discount_share_events" ("chain_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_e8f8c0d2bfb45146cd9640e9ac" ON "set_referrer_discount_share_events" ("timestamp") `);
        await queryRunner.query(`CREATE TABLE "pair-trading-fee-ppm-updated-events" ("id" SERIAL NOT NULL, "blockchainType" character varying NOT NULL, "exchangeId" character varying NOT NULL, "timestamp" TIMESTAMP NOT NULL, "prevFeePPM" integer NOT NULL, "newFeePPM" integer NOT NULL, "transactionIndex" integer NOT NULL, "transactionHash" character varying NOT NULL, "logIndex" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "pairId" integer, "blockId" integer, CONSTRAINT "UQ_9c812bc262cb7467560cf562ad4" UNIQUE ("transactionIndex", "transactionHash", "logIndex"), CONSTRAINT "PK_1020b3004ba5966b027e8a08d54" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_3ecc36cb48e31b527dc43f307f" ON "pair-trading-fee-ppm-updated-events" ("blockId") `);
        await queryRunner.query(`CREATE INDEX "IDX_0a2ca9f9e49c70f49970fb9dcf" ON "pair-trading-fee-ppm-updated-events" ("blockchainType") `);
        await queryRunner.query(`CREATE INDEX "IDX_13877d16eb7f4665c50993f657" ON "pair-trading-fee-ppm-updated-events" ("exchangeId") `);
        await queryRunner.query(`CREATE TABLE "set_referrer_tier_events" ("id" SERIAL NOT NULL, "blockchainType" character varying NOT NULL, "exchangeId" character varying NOT NULL, "referrer" character varying(42) NOT NULL, "tierId" character varying NOT NULL, "chain_id" integer NOT NULL, "transactionIndex" integer NOT NULL, "transactionHash" character varying NOT NULL, "logIndex" integer NOT NULL, "timestamp" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "blockId" integer, CONSTRAINT "UQ_5dcb7325ba74ec054568004e7e6" UNIQUE ("transactionIndex", "transactionHash", "logIndex"), CONSTRAINT "PK_d7ce0c1c5a1027ef50ee635a2c6" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_dd0a21ee51227853f4c9d25b7d" ON "set_referrer_tier_events" ("blockchainType") `);
        await queryRunner.query(`CREATE INDEX "IDX_f3847a6fe869814230e03cb70c" ON "set_referrer_tier_events" ("exchangeId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_502202ce09ffba6751ac748633" ON "set_referrer_tier_events" ("timestamp") `);
        await queryRunner.query(`CREATE TABLE "gov_set_code_owner_events" ("id" SERIAL NOT NULL, "blockchainType" character varying NOT NULL, "exchangeId" character varying NOT NULL, "code" character varying(66) NOT NULL, "code_decoded" character varying(255), "newAccount" character varying(42) NOT NULL, "chain_id" integer NOT NULL, "transactionIndex" integer NOT NULL, "transactionHash" character varying NOT NULL, "logIndex" integer NOT NULL, "timestamp" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "blockId" integer, CONSTRAINT "UQ_8d03d95c9c1277a5b27aaae9c2e" UNIQUE ("transactionIndex", "transactionHash", "logIndex"), CONSTRAINT "PK_04d905adf9bd8f875ebf3649b3c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_b6c2c0bebb4948f658fe37ae7e" ON "gov_set_code_owner_events" ("blockchainType") `);
        await queryRunner.query(`CREATE INDEX "IDX_345e934745ca655c55d55bee67" ON "gov_set_code_owner_events" ("exchangeId") `);
        await queryRunner.query(`CREATE INDEX "IDX_ae30231a7cad015ac3c5da1997" ON "gov_set_code_owner_events" ("blockId") `);
        await queryRunner.query(`CREATE INDEX "IDX_4e97fe0fcd63120178f9451cd9" ON "gov_set_code_owner_events" ("chain_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_7734f78d66f1f8a31a09f3aca5" ON "gov_set_code_owner_events" ("timestamp") `);
        ...
        await queryRunner.query(`ALTER TABLE "tokens-traded-events" ADD CONSTRAINT "FK_bff069546ba7ea84e319446a267" FOREIGN KEY ("blockId") REFERENCES "blocks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tokens-traded-events" ADD CONSTRAINT "FK_c081dde529d0e03627b56844e45" FOREIGN KEY ("pairId") REFERENCES "pairs"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tokens-traded-events" ADD CONSTRAINT "FK_c03a21b4dead9ab3345f3ad4902" FOREIGN KEY ("sourceTokenId") REFERENCES "tokens"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tokens-traded-events" ADD CONSTRAINT "FK_4bec19484efcbe1a523521c5fe9" FOREIGN KEY ("targetTokenId") REFERENCES "tokens"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "pairs" ADD CONSTRAINT "FK_c68180ccb7c24531e2795b294ae" FOREIGN KEY ("blockId") REFERENCES "blocks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "pairs" ADD CONSTRAINT "FK_fc7983e49c0c77fe123cb43b3c9" FOREIGN KEY ("token0Id") REFERENCES "tokens"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "pairs" ADD CONSTRAINT "FK_e4001a1eedce46eb130d0d7a941" FOREIGN KEY ("token1Id") REFERENCES "tokens"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "strategies" ADD CONSTRAINT "FK_0b83ed9a45964f7abc611abf4d7" FOREIGN KEY ("blockId") REFERENCES "blocks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "strategies" ADD CONSTRAINT "FK_f7fb6533dfb9a761cedf52cfc91" FOREIGN KEY ("pairId") REFERENCES "pairs"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "strategies" ADD CONSTRAINT "FK_7d86dcba41d17e33e08296701b5" FOREIGN KEY ("token0Id") REFERENCES "tokens"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "strategies" ADD CONSTRAINT "FK_849fe4369e56efc231535a9b545" FOREIGN KEY ("token1Id") REFERENCES "tokens"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "quotes" ADD CONSTRAINT "FK_50aa379b097f3082da450455f88" FOREIGN KEY ("tokenId") REFERENCES "tokens"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "activities-v2" ADD CONSTRAINT "FK_b00f82c523e04d902a52f96a0c7" FOREIGN KEY ("token0Id") REFERENCES "tokens"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "activities-v2" ADD CONSTRAINT "FK_09c42c10e51e5b43cb051bc3afc" FOREIGN KEY ("token1Id") REFERENCES "tokens"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "referral_states" ADD CONSTRAINT "FK_c9061346470df921f32fbf12cfe" FOREIGN KEY ("block_id") REFERENCES "blocks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "referral_codes" ADD CONSTRAINT "FK_d846520cb1b945243698aa25b5e" FOREIGN KEY ("block_id") REFERENCES "blocks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "voucher-transfer-events" ADD CONSTRAINT "FK_dcceb3e56b344cc9c8c703ae2d4" FOREIGN KEY ("blockId") REFERENCES "blocks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "strategy-updated-events" ADD CONSTRAINT "FK_82cb0ebf64bd87a123f7c152d9f" FOREIGN KEY ("pairId") REFERENCES "pairs"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "strategy-updated-events" ADD CONSTRAINT "FK_f6cd36e84afc2fdf1d9cea35cec" FOREIGN KEY ("blockId") REFERENCES "blocks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "strategy-updated-events" ADD CONSTRAINT "FK_1eb8296ac6180bbc2e05ef7af3a" FOREIGN KEY ("token0Id") REFERENCES "tokens"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "strategy-updated-events" ADD CONSTRAINT "FK_f0be62f9a5e4fe9a02b57c4c02f" FOREIGN KEY ("token1Id") REFERENCES "tokens"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "trading-fee-ppm-updated-events" ADD CONSTRAINT "FK_aca9132d7db5f03850246670044" FOREIGN KEY ("blockId") REFERENCES "blocks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "strategy-created-events" ADD CONSTRAINT "FK_f1ee68d9ed410aaba255fe984c3" FOREIGN KEY ("pairId") REFERENCES "pairs"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "strategy-created-events" ADD CONSTRAINT "FK_9c5a2e9a334403254efb836f04e" FOREIGN KEY ("blockId") REFERENCES "blocks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "strategy-created-events" ADD CONSTRAINT "FK_92fe5683849f39db695c9b4995a" FOREIGN KEY ("token0Id") REFERENCES "tokens"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "strategy-created-events" ADD CONSTRAINT "FK_d580d7fd7977675aaf649e0b7f6" FOREIGN KEY ("token1Id") REFERENCES "tokens"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "strategy-deleted-events" ADD CONSTRAINT "FK_ddac7ee8a786ed10b4bf750b511" FOREIGN KEY ("pairId") REFERENCES "pairs"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "strategy-deleted-events" ADD CONSTRAINT "FK_eac564b54c2e686f3bbbdfb7f74" FOREIGN KEY ("blockId") REFERENCES "blocks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "strategy-deleted-events" ADD CONSTRAINT "FK_f7bc0579a75b1d5106c772a3b20" FOREIGN KEY ("token0Id") REFERENCES "tokens"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "strategy-deleted-events" ADD CONSTRAINT "FK_0a5bda86b666abda143f8ce0f53" FOREIGN KEY ("token1Id") REFERENCES "tokens"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "protection-removed-events" ADD CONSTRAINT "FK_931a18b62f3a83d583b1990458b" FOREIGN KEY ("blockId") REFERENCES "blocks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "set_handler_events" ADD CONSTRAINT "FK_55cf66bbdad2dbbfeb119e4b14f" FOREIGN KEY ("blockId") REFERENCES "blocks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "set_code_owner_events" ADD CONSTRAINT "FK_dc1111eef55ee1b12091e036b6d" FOREIGN KEY ("blockId") REFERENCES "blocks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "set_tier_events" ADD CONSTRAINT "FK_0cf86248766437fdf8ba387c454" FOREIGN KEY ("blockId") REFERENCES "blocks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "register_code_events" ADD CONSTRAINT "FK_747cbb2c5c9fd66f886cb6f4b56" FOREIGN KEY ("blockId") REFERENCES "blocks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "set_trader_referral_code_events" ADD CONSTRAINT "FK_dcc1860c4507bfd4541579ba122" FOREIGN KEY ("blockId") REFERENCES "blocks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "pair-created-events" ADD CONSTRAINT "FK_9fdb1161b3305a336be4ae4b83d" FOREIGN KEY ("blockId") REFERENCES "blocks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "set_referrer_discount_share_events" ADD CONSTRAINT "FK_6e7359ba2064496b809f1855d4e" FOREIGN KEY ("blockId") REFERENCES "blocks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "pair-trading-fee-ppm-updated-events" ADD CONSTRAINT "FK_e709c1f59d782d5586b33e9e8a8" FOREIGN KEY ("pairId") REFERENCES "pairs"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "pair-trading-fee-ppm-updated-events" ADD CONSTRAINT "FK_3ecc36cb48e31b527dc43f307f6" FOREIGN KEY ("blockId") REFERENCES "blocks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "set_referrer_tier_events" ADD CONSTRAINT "FK_47e92137010ec8babd276f5e070" FOREIGN KEY ("blockId") REFERENCES "blocks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "gov_set_code_owner_events" ADD CONSTRAINT "FK_ae30231a7cad015ac3c5da19975" FOREIGN KEY ("blockId") REFERENCES "blocks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "pair-trading-fee-ppm-updated-events" DROP CONSTRAINT "FK_3ecc36cb48e31b527dc43f307f6"`);
        await queryRunner.query(`ALTER TABLE "pair-trading-fee-ppm-updated-events" DROP CONSTRAINT "FK_e709c1f59d782d5586b33e9e8a8"`);
        await queryRunner.query(`ALTER TABLE "set_referrer_discount_share_events" DROP CONSTRAINT "FK_6e7359ba2064496b809f1855d4e"`);
        await queryRunner.query(`ALTER TABLE "pair-created-events" DROP CONSTRAINT "FK_9fdb1161b3305a336be4ae4b83d"`);
        await queryRunner.query(`ALTER TABLE "set_trader_referral_code_events" DROP CONSTRAINT "FK_dcc1860c4507bfd4541579ba122"`);
        ...
        await queryRunner.query(`ALTER TABLE "trading-fee-ppm-updated-events" DROP CONSTRAINT "FK_aca9132d7db5f03850246670044"`);
